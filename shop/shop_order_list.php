...
<head>
    ...
    <title>Customer Order List | Pizza World</title>
</head>
                                ...
                                <div class="card-body">
                                    <div class="card-text row row-cols-1">
                                        ...
                                        <div class="col">Name:
                                            ...
                                            $cust_arr = $mysqli -> query($cust_query) -> fetch_array();
                                            switch($cust_arr["c_type"]){
                                                case "STD": $cust_type = "Below 15 years"; break;
                                                case "INS": $cust_type = "16 years - 20 years"; break;
                                                case "TAS": $cust_type = "21 years - 30 years"; break;
                                                case "STF": $cust_type = "31 years - 40 years"; break;
                                                case "GUE": $cust_type = "41 years - 50 years"; break;
                                                default: $cust_type = "Above 51 years";
                                            }
                                            echo "{$cust_arr['c_firstname']} {$cust_arr['c_lastname']} ({$cust_type})";
                                        ?>
                                        </div>
