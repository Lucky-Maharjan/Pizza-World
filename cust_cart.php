...
<head>
    ...
    <title>My Cart | Pizza World</title>
</head>
...
<?php
            if(isset($_SESSION['orh_id'])){ ?>
                <a href="admin/order_success.php?id=<?php echo $order_detail[0]['p_id']; ?>"
                class="omise-checkout-button" style="color: #fff !important;">
                <i class="fas fa-cart-arrow-down"></i> Confirm Order</a>
           <?php } else{?>
            <a href="admin/order_success.php?id=<?php echo $orh["orh_id"]; ?>"
            class="omise-checkout-button" style="color: #fff !important;">
...
data-frame-label="Pizza World"
data-button-label="Online Payment"
